...
<div class="container-fluid">
  <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            Title: <textarea name="title" id="" cols="30" rows="2"></textarea>
            Text: <textarea name="text" id="" cols="30" rows="5"></textarea>
            ...
            <input type="file" name="img" class="form-control" id="exampleFormControlFile1">
                <input type="submit" name="post-create" class="btn btn-primary" value="Ok">
                </div>
            </form>
    </div>
</div>